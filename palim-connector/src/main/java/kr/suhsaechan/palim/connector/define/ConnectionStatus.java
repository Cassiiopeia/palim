...
public enum ConnectionStatus {
     ...
     * 테스트 키로 검증을 통과했다.
     *
     * <p><b>여기서 끝이 아니다.</b> 테스트 키는 유효기간이 짧고(보통 2주) 테스트 주소를 부르므로
     * 매일 도는 수집에는 쓸 수 없다. 기간이 지나면 어느 날 갑자기 멈춘다. 화면이 정식 키 교체를
     * 안내해야 한다 — 안 그러면 사용자는 검증에 성공했으니 끝난 줄 알고 있다가 나중에 막힌다.
     *
     * <p>이 상태로도 <b>연결 정보는 저장해 둔다.</b> 검증에 성공한 회사코드·사용자 ID·접속 주소를
     * 버릴 이유가 없고, 칸 맞추기는 미리 해 둘 수 있다. 정식 키는 나중에 갈아 끼운다.
     */
