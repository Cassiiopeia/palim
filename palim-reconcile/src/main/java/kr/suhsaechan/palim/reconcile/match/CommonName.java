...
/**
 * 여러 품목을 한 묶음으로 묶을 때 <b>무엇이라 부를 것인가.</b>
 *
 * <p>예전에는 <b>첫 품목의 이름을 그대로</b> 묶음 이름으로 썼다. 그래서 로트 네 개를 묶은
 * 묶음이 「클래식 850g (27.03.16)」 이 되었다 — <b>특정 로트 날짜가 전체를 대표</b>하게 된 것이다.
...
public final class CommonName {
    ...
    /** 이보다 짧아지면 무슨 묶음인지 알 수 없다 — 그럴 바엔 원래 이름이 낫다. */
    ...
    public static String of(List<String> leftNames, List<String> rightNames) {
        ...
        if (usable.size() == 1) {
            // 자를 것이 없다. 하나뿐인 품목의 이름이 곧 그 묶음의 이름이다.
